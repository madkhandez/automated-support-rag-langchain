...
from part5_production.api.main import app
from part5_production.api.main import ProductionRAGPipeline

client = TestClient(app)

@pytest.fixture
def mock_rag_pipeline():
    """Mock the RAG pipeline to avoid requiring real API keys."""
    mock_pipeline = MagicMock(spec=ProductionRAGPipeline)
...
def test_file_ingest_endpoint(mock_rag_pipeline):
    ...
    mock_rag_pipeline.ingest_file.assert_called_once()
